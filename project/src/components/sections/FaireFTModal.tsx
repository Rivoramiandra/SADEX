        ...
        <div className="bg-white rounded-xl shadow-2xl w-full max-w-6xl max-h-[90vh] overflow-y-auto">
          ...
          <div className="sticky top-0 bg-white border-b border-slate-200 p-6 flex justify-between items-center z-10">
            ...
            <div className="flex items-center gap-2">
              ...
              <button className="p-2 hover:bg-slate-100 rounded-full" title="Imprimer" disabled={saving}>
                <Printer className="w-5 h-5 text-slate-600" />
              </button>
              <button className="p-2 hover:bg-slate-100 rounded-full" title="Exporter" disabled={saving}>
                <Download className="w-5 h-5 text-slate-600" />
              </button>
              <button className="p-2 hover:bg-slate-100 rounded-full" title="Envoyer par email" disabled={saving}>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-xl shadow-2xl p-6 max-w-md w-full">
            ...
            <p className="text-slate-600 mb-6">
              Êtes-vous sûr de vouloir créer ce procès-verbal ? Cela marquera le rendez-vous comme fini et redirigera vers la liste.
            </p>
